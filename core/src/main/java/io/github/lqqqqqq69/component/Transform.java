...
/**
 * Der Transform Komponent beschreibt die Position, die Größe, das Scaling, die Rotierung sowie das sortOffset einer Entität
 */
public class Transform implements Component, Comparable<Transform> {
    ...
    private float sortOffsetY;      // Offset 

    public Transform(Vector2 position, int z, Vector2 size, Vector2 scaling, float rotationDeg, float sortOffsetY) {
    ...
    /**
     * compareTo liefert die Vergleichslogik für die Sortierung von Komponenten (auf der Map)
     * - Vergelich der Z-Ebene, wenn ungleich
     * - Vergleich der Y-Ebene + Offset, wenn ungleich
     * - Vergleich der X - Ebene
     */
    @Override
